...
(function ($) {
    $.fn.sectionScroll = function (options) {
        ...
        $bullets = '<div class="aside-container"><div class="fixed-side_nav vertically_center"><div class="partial-indicators"><ul class="'+ $bullets_class +'"></ul></div></div></div>';
        $mainSection.after($bullets);
        ...
        $('.' + $section_elem).each(function () {
            ...
            $sec_id++;
            $('.' + $bullets_class).append('<li><a title="' + $(this).data('section-title') + '" href="#scrollto-section-' + $sec_id + '"><span class="omens-medium">' + $(this).data('section-title') + '</span></a></li>');
            $section_number++;
            totalSections++;
